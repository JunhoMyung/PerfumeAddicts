...
const filter = () => {
    ...
    return (
        ...
        // follow background html, css form from the main page

        //Tab for women, men

        <table> Women / Men </table>

        //like figma implementation

        <h1> PERFUME FINDER </h1>
        <h2> Choose scents to avoid: </h2>

        //filtering choices, enable multiple selection 
        ...
        {/* // showing image of perfumes, clickable --> perfume info --> */}
        ...
        <p><small> Type </small></p></div></div>
        </div>

        // SEARCH BAR(?)
        // JS filtering function
